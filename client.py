...
class MicrosoftGraphClient():
    ...
    def __init__(self, client_id: str, client_secret: str, redirect_uri: str,
                 scope: List[str], account_type: str = 'common',
    ...
    def presence(self):
        ...
        ---
        Presence:
            The `Presence` services Object.
        """

        # Grab the Presence Object for the session.
        presence_object: Presence = Presence(session=self.graph_session)
